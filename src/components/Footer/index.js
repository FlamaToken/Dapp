      ...
      <footer>
        <div className="container">
          <ul className="social-links">
            <li>
              <a href="https://github.com/FlamaToken/" target="_blank" rel="noopener noreferrer">
            ...
            <li>
              <a href="https://t.me/flamatoken/" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <defs />
            ...
            <li>
              <a href="https://twitter.com/FlamaToken/" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <defs />
            ...
            <li>
              <a href="https://flamateam.medium.com/" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <defs />
          ...
          <a href="https://flamanet.io/" target="_blank" rel="noopener noreferrer" className="ext">
            To Flama{" "}
            <svg
